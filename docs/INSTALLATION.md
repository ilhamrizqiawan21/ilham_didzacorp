...
`resources/js/inertia.ts` memuat aplikasi Inertia + Vue. Blade dipakai untuk root Inertia, halaman error, dan template dokumen PDF; seluruh halaman aplikasi utama menggunakan shell Vue.
