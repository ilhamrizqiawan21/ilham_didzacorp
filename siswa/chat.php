...
<div class="page-header">
    <h2 class="page-title"><i class="fas fa-comments"></i> Chat Kelas <?= htmlspecialchars($kelas_nama) ?></h2>
    <p class="page-subtitle">Diskusi dengan guru dan teman sekelas</p>
</div>
...
<div class="form-container">
    ...
    <div class="input-group">
        <textarea id="messageInput" rows="2" placeholder="Tulis pesan... (Enter untuk kirim, Shift+Enter untuk baris baru)"></textarea>
