...
// The single teacher account is the application manager as well as the instructor.
// Keep the existing /admin route namespace so the established Laravel UI and
// links remain compatible, but authorize it for the guru role.
Route::middleware(['auth', 'role:guru'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('/pengaturan/pembelajaran', [SystemController::class, 'saveTeaching'])->name('pengaturan.teaching.save');
...
Route::middleware(['auth', 'role:guru'])->prefix('guru')->name('guru.')->group(function () {
    ...
    Route::get('/nilai', [NilaiRekapController::class, 'index'])->name('nilai.index');
    Route::post('/nilai/store', [NilaiRekapController::class, 'storeBulk'])->name('nilai.store.bulk');
    Route::get('/nilai/{kelasMapel}/input', [NilaiRekapController::class, 'input'])->name('nilai.input')->middleware('can:mengajar,kelasMapel');
    ...
    Route::post('/nilai/{kelasMapel}/store', [NilaiRekapController::class, 'store'])->name('nilai.store')->middleware('can:mengajar,kelasMapel');
    Route::get('/sikap', [SikapRekapController::class, 'index'])->name('sikap.index');
    Route::post('/sikap/store', [SikapRekapController::class, 'storeBulk'])->name('sikap.store.bulk');
    Route::get('/sikap/{kelasMapel}/input', [SikapRekapController::class, 'input'])->name('sikap.input')->middleware('can:mengajar,kelasMapel');
    ...
    Route::post('/sikap/{kelasMapel}/store', [SikapRekapController::class, 'store'])->name('sikap.store')->middleware('can:mengajar,kelasMapel');
    Route::get('/rekap-nilai', [NilaiRekapController::class, 'rekap'])->name('rekap-nilai');
    Route::get('/rekap-nilai/export/excel', [NilaiRekapController::class, 'exportExcel'])->name('rekap-nilai.export.excel');
    Route::get('/rekap-nilai/export/pdf', [NilaiRekapController::class, 'exportPdf'])->name('rekap-nilai.export.pdf');
    Route::get('/rekap-sikap', [SikapRekapController::class, 'rekap'])->name('rekap-sikap');
