...
// Header
$sheet->setCellValue('A1', 'ALUR TUJUAN PEMBELAJARAN (ATP)');
...
while ($d = mysqli_fetch_assoc($data)) {
    ...
    $sheet->setCellValue('D' . $row, $d['materi']);
...
header('Content-Disposition: attachment;filename="ATP_'.($semester ? 'Semester_'.$semester.'_' : '').date('Ymd').'.xlsx"');
